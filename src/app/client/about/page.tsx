          ...
          <div className="flex flex-col justify-center items-start  w-full md:w-[50%] lg:w-[640px]">
            ...
            <div className="flex items-center gap-3">
              ...
              <p>
                ...
                confidence in every customer.
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Image src={symbol} alt="Symbol" width={40} height={40} />
              <p>
                Our commitment is to bring you the latest trends while ensuring
        ...
        <div className="relative mb-5 hidden md:block  mx-4">
          ...
          <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-center">
            <div className="bg-[#EDF5F5]  p-10 text-center space-y-6">
              ...
              <p className="text-lg">
                By connecting our community with top-rated products, we inspire
                confidence and celebrate the beauty in diversity for everyone.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative  mx-4 md:hidden">
          ...
          <div className="absolute top-0 bottom-0 left-0 right-0 flex flex-col justify-center items-center bg-[#EDF5F5]  text-center rounded-md ">
            <p className="text-sm w-full h-[50%] ">
              We are dedicated to providing a seamless shopping experience that
              prioritizes convenience, inclusivity, and customer satisfaction.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 md:px-8 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 mt-10">
          {cores.map((core) => (
            <div
              key={core.id}
              className="bg-[#EDF5F3] w-full md:w-1/3 h-auto rounded-lg flex flex-col items-center justify-center p-5 m-2 shadow"
            >
              <Image
                src={core.src}
                alt={core.alt}
